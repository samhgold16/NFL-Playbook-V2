...
def print_config_summary(config: DetectionTrackerConfig) -> None:
    ...
    print()
    print("  Camera Stabilization (CameraStabilizer):")
    ...
    print()
    print("  Field Orientation Correction:")
    print(f"    Enabled: {config.field_orientation_config.enabled}")
    print()
    print("  NFL Filter:")
    ...
    print()
    print("  Trajectory Post-Processing:")
    print(f"    Min Length: {config.tracker_config.min_trajectory_length} detections")
    print(f"    Trajectory Merging: {config.tracker_config.enable_trajectory_merging}")
    print()
