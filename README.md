...
- same thing for video_loader, run "PYTHONPATH=src python -m nfl_route_tracker.core.video_loader"
  - currently uses the test videos from test_video_generator as the test case in next = main